...
import (
	...
	proto_enterprise "github.com/keeper-security/keeper-sdk-golang/sdk/internal/proto_enterprise"
	reflect "reflect"
	sync "sync"
)
...
type TimeLimitedAccessType int32

const (
	TimeLimitedAccessType_INVALID_TIME_LIMITED_ACCESS_TYPE    TimeLimitedAccessType = 0
	TimeLimitedAccessType_USER_ACCESS_TO_RECORD               TimeLimitedAccessType = 1
	TimeLimitedAccessType_USER_OR_TEAM_ACCESS_TO_SHAREDFOLDER TimeLimitedAccessType = 2
	TimeLimitedAccessType_RECORD_ACCESS_TO_SHAREDFOLDER       TimeLimitedAccessType = 3
)

// Enum value maps for TimeLimitedAccessType.
var (
	TimeLimitedAccessType_name = map[int32]string{
		0: "INVALID_TIME_LIMITED_ACCESS_TYPE",
		1: "USER_ACCESS_TO_RECORD",
		2: "USER_OR_TEAM_ACCESS_TO_SHAREDFOLDER",
		3: "RECORD_ACCESS_TO_SHAREDFOLDER",
	}
	TimeLimitedAccessType_value = map[string]int32{
...
func (x TimeLimitedAccessType) Enum() *TimeLimitedAccessType {
	p := new(TimeLimitedAccessType)
	*p = x
	return p
}

func (x TimeLimitedAccessType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TimeLimitedAccessType) Descriptor() protoreflect.EnumDescriptor {
	return file_APIRequest_proto_enumTypes[22].Descriptor()
}

func (TimeLimitedAccessType) Type() protoreflect.EnumType {
	return &file_APIRequest_proto_enumTypes[22]
}

func (x TimeLimitedAccessType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TimeLimitedAccessType.Descriptor instead.
func (TimeLimitedAccessType) EnumDescriptor() ([]byte, []int) {
...
type TimeLimitedAccessRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	AccountUid            [][]byte              `protobuf:"bytes,1,rep,name=accountUid,proto3" json:"accountUid,omitempty"`           //list of users that have access to a record or shared folder
	TeamUid               [][]byte              `protobuf:"bytes,2,rep,name=teamUid,proto3" json:"teamUid,omitempty"`                 //list of teams that have access to a shared folder
	RecordUid             [][]byte              `protobuf:"bytes,3,rep,name=recordUid,proto3" json:"recordUid,omitempty"`             //list of records that have access to a shared folder (aka that are shared via a shared folder)
	SharedObjectUid       []byte                `protobuf:"bytes,4,opt,name=sharedObjectUid,proto3" json:"sharedObjectUid,omitempty"` //recordUid or sharedFolderUid of which the timer will be set or deleted
	TimeLimitedAccessType TimeLimitedAccessType `protobuf:"varint,5,opt,name=timeLimitedAccessType,proto3,enum=Authentication.TimeLimitedAccessType" json:"timeLimitedAccessType,omitempty"`
	Expiration            int64                 `protobuf:"varint,6,opt,name=expiration,proto3" json:"expiration,omitempty"` //delete timer when expiration==0
}

func (x *TimeLimitedAccessRequest) Reset() {
	*x = TimeLimitedAccessRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *TimeLimitedAccessRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TimeLimitedAccessRequest) ProtoMessage() {}

func (x *TimeLimitedAccessRequest) ProtoReflect() protoreflect.Message {
	mi := &file_APIRequest_proto_msgTypes[117]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TimeLimitedAccessRequest.ProtoReflect.Descriptor instead.
func (*TimeLimitedAccessRequest) Descriptor() ([]byte, []int) {
	return file_APIRequest_proto_rawDescGZIP(), []int{117}
}

func (x *TimeLimitedAccessRequest) GetAccountUid() [][]byte {
	if x != nil {
		return x.AccountUid
	}
	return nil
...
func (x *TimeLimitedAccessRequest) GetTeamUid() [][]byte {
	if x != nil {
		return x.TeamUid
	}
	return nil
...
func (x *TimeLimitedAccessRequest) GetRecordUid() [][]byte {
	if x != nil {
		return x.RecordUid
	}
	return nil
...
func (x *TimeLimitedAccessRequest) GetSharedObjectUid() []byte {
	if x != nil {
		return x.SharedObjectUid
	}
	return nil
}

func (x *TimeLimitedAccessRequest) GetTimeLimitedAccessType() TimeLimitedAccessType {
	if x != nil {
		return x.TimeLimitedAccessType
	}
	return TimeLimitedAccessType_INVALID_TIME_LIMITED_ACCESS_TYPE
}

func (x *TimeLimitedAccessRequest) GetExpiration() int64 {
	if x != nil {
		return x.Expiration
	}
	return 0
...
type TimeLimitedAccessStatus struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Uid     []byte `protobuf:"bytes,1,opt,name=uid,proto3" json:"uid,omitempty"` // accountUid or teamUid or recordUid
	Message string `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
}

func (x *TimeLimitedAccessStatus) Reset() {
	*x = TimeLimitedAccessStatus{}
	if protoimpl.UnsafeEnabled {
...
func (x *TimeLimitedAccessStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TimeLimitedAccessStatus) ProtoMessage() {}

func (x *TimeLimitedAccessStatus) ProtoReflect() protoreflect.Message {
	mi := &file_APIRequest_proto_msgTypes[118]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TimeLimitedAccessStatus.ProtoReflect.Descriptor instead.
func (*TimeLimitedAccessStatus) Descriptor() ([]byte, []int) {
	return file_APIRequest_proto_rawDescGZIP(), []int{118}
}

func (x *TimeLimitedAccessStatus) GetUid() []byte {
	if x != nil {
		return x.Uid
	}
	return nil
...
func (x *TimeLimitedAccessStatus) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
type TimeLimitedAccessResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Revision           int64                      `protobuf:"varint,1,opt,name=revision,proto3" json:"revision,omitempty"`
	UserAccessStatus   []*TimeLimitedAccessStatus `protobuf:"bytes,2,rep,name=userAccessStatus,proto3" json:"userAccessStatus,omitempty"`     // uid is accountUid
	TeamAccessStatus   []*TimeLimitedAccessStatus `protobuf:"bytes,3,rep,name=teamAccessStatus,proto3" json:"teamAccessStatus,omitempty"`     // uid is teamUid
	RecordAccessStatus []*TimeLimitedAccessStatus `protobuf:"bytes,4,rep,name=recordAccessStatus,proto3" json:"recordAccessStatus,omitempty"` // uid is recordUid
}

func (x *TimeLimitedAccessResponse) Reset() {
	*x = TimeLimitedAccessResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *TimeLimitedAccessResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TimeLimitedAccessResponse) ProtoMessage() {}

func (x *TimeLimitedAccessResponse) ProtoReflect() protoreflect.Message {
	mi := &file_APIRequest_proto_msgTypes[119]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TimeLimitedAccessResponse.ProtoReflect.Descriptor instead.
func (*TimeLimitedAccessResponse) Descriptor() ([]byte, []int) {
	return file_APIRequest_proto_rawDescGZIP(), []int{119}
}

func (x *TimeLimitedAccessResponse) GetRevision() int64 {
	if x != nil {
		return x.Revision
	}
	return 0
...
func (x *TimeLimitedAccessResponse) GetUserAccessStatus() []*TimeLimitedAccessStatus {
	if x != nil {
		return x.UserAccessStatus
	}
	return nil
}

func (x *TimeLimitedAccessResponse) GetTeamAccessStatus() []*TimeLimitedAccessStatus {
	if x != nil {
		return x.TeamAccessStatus
	}
	return nil
}

func (x *TimeLimitedAccessResponse) GetRecordAccessStatus() []*TimeLimitedAccessStatus {
	if x != nil {
		return x.RecordAccessStatus
	}
	return nil
}
...
var file_APIRequest_proto_rawDesc = []byte{
	...
	0x64, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xee, 0x02, 0x0a, 0x14,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x24, 0x0a, 0x0d, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74,
	...
	0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0f, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x50, 0x75, 0x62,
	0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x12, 0x40, 0x0a, 0x0c, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65,
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x41,
	...
	0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xc3, 0x01, 0x0a, 0x1d, 0x52, 0x65, 0x67,
	0x69, 0x73, 0x74, 0x65, 0x72, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x49, 0x6e, 0x52, 0x65, 0x67,
	0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x32, 0x0a, 0x14, 0x65, 0x6e,
	0x63, 0x72, 0x79, 0x70, 0x74, 0x65, 0x64, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x54, 0x6f, 0x6b,
	0x65, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x14, 0x65, 0x6e, 0x63, 0x72, 0x79, 0x70,
	0x74, 0x65, 0x64, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x24,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x69, 0x73, 0x65, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x30, 0x0a, 0x13, 0x63, 0x75, 0x72,
	...
	,
	...
	0x12, 0x30, 0x0a, 0x13, 0x65, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x65, 0x64, 0x52, 0x65, 0x70,
	0x6f, 0x72, 0x74, 0x44, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x13, 0x65,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x6e, 0x74, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x1e, 0x0a, 0x0a, 0x64, 0x65, 0x76,
	...
	0x69, 0x63, 0x65, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0c, 0x52, 0x0f, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63,
	0x4b, 0x65, 0x79, 0x22, 0xf1, 0x01, 0x0a, 0x19, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x56, 0x65,
	0x72, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x32, 0x0a, 0x14, 0x65, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x65, 0x64, 0x44, 0x65,
	...
	0x65, 0x12, 0x30, 0x0a, 0x13, 0x76, 0x65, 0x72, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x13,
	0x76, 0x65, 0x72, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x68, 0x61, 0x6e,
	0x6e, 0x65, 0x6c, 0x12, 0x2c, 0x0a, 0x11, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x53, 0x65,
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x55, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x11,
	...
	,
	...
	,
	...
	,
	...
	0x61, 0x6c, 0x69, 0x61, 0x73, 0x22, 0x7b, 0x0a, 0x1d, 0x45, 0x6e, 0x74, 0x65, 0x72, 0x70, 0x72,
	0x69, 0x73, 0x65, 0x55, 0x73, 0x65, 0x72, 0x41, 0x64, 0x64, 0x41, 0x6c, 0x69, 0x61, 0x73, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2a, 0x0a, 0x10, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x70,
	...
	,
	...
	0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x24, 0x0a, 0x0d, 0x63, 0x6c, 0x69, 0x65, 0x6e,
	0x74, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d,
	0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x2a, 0x0a,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x64, 0x65, 0x22, 0xf7, 0x01, 0x0a, 0x25, 0x56, 0x61,
	0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x56, 0x65, 0x72, 0x69,
	...
	0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x2a, 0x0a, 0x10, 0x76, 0x65, 0x72, 0x69, 0x66, 0x69, 0x63,
	...
	0x69, 0x6f, 0x6e, 0x55, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x11, 0x6d, 0x65,
	...
	0x63, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x14, 0x65,
	0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x65, 0x64, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x54, 0x6f,
	0x6b, 0x65, 0x6e, 0x22, 0x7f, 0x0a, 0x19, 0x53, 0x65, 0x6e, 0x64, 0x53, 0x65, 0x73, 0x73, 0x69,
	...
	,
	...
	,
	...
	0x61, 0x74, 0x65, 0x22, 0x9a, 0x02, 0x0a, 0x0e, 0x54, 0x68, 0x72, 0x6f, 0x74, 0x74, 0x6c, 0x65,
	0x53, 0x74, 0x61, 0x74, 0x65, 0x32, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x26, 0x0a, 0x0e, 0x6b, 0x65, 0x79, 0x44,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x2a, 0x0a, 0x10, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x44,
	0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x10, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69,
	...
	,
	...
	,
	...
	0x6f, 0x67, 0x69, 0x6e, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x7c, 0x0a, 0x1c, 0x47, 0x65, 0x74,
	0x53, 0x65, 0x63, 0x75, 0x72, 0x69, 0x74, 0x79, 0x51, 0x75, 0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e,
	0x56, 0x33, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x30, 0x0a, 0x13, 0x65, 0x6e, 0x63,
	0x72, 0x79, 0x70, 0x74, 0x65, 0x64, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x54, 0x6f, 0x6b, 0x65, 0x6e,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x13, 0x65, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x65,
	0x64, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x2a, 0x0a, 0x10, 0x76,
	...
	,
	...
	0x01, 0x28, 0x05, 0x52, 0x0a, 0x69, 0x74, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22,
	0xa9, 0x01, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x44, 0x61, 0x74, 0x61, 0x4b, 0x65, 0x79, 0x42, 0x61,
	0x63, 0x6b, 0x75, 0x70, 0x56, 0x33, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x30, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x79, 0x70, 0x65, 0x52, 0x09, 0x73, 0x68, 0x61, 0x72, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1a,
	0x0a, 0x08, 0x65, 0x64, 0x69, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x08, 0x65, 0x64, 0x69, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x63, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x64, 0x4f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x63,
	0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x4f, 0x6e, 0x22, 0xc2, 0x02, 0x0a, 0x13, 0x41, 0x64, 0x64,
	0x41, 0x70, 0x70, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	,
	...
	,
	...
	,
	...
	0x61, 0x6d, 0x65, 0x73, 0x22, 0x83, 0x01, 0x0a, 0x17, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x67, 0x65, 0x12, 0x36, 0x0a, 0x09, 0x64, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x73, 0x18,
	0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x41, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74, 0x69,
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x52,
	0x09, 0x64, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x73, 0x22, 0x66, 0x0a, 0x08, 0x44, 0x6f,
	0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x66, 0x69, 0x6c, 0x65, 0x4e, 0x61,
	...
	0x03, 0x75, 0x72, 0x6c, 0x12, 0x2c, 0x0a, 0x11, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x43, 0x6f, 0x64, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52,
	0x11, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x43, 0x6f,
	0x64, 0x65, 0x22, 0x2b, 0x0a, 0x11, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72,
	...
	,
...
var file_APIRequest_proto_enumTypes = make([]protoimpl.EnumInfo, 24)
var file_APIRequest_proto_msgTypes = make([]protoimpl.MessageInfo, 128)
var file_APIRequest_proto_goTypes = []interface{}{
	...
	(AlternateAuthenticationType)(0),                  // 18: Authentication.AlternateAuthenticationType
	(ThrottleType)(0),                                 // 19: Authentication.ThrottleType
	(Region)(0),                                       // 20: Authentication.Region
	(ApplicationShareType)(0),                         // 21: Authentication.ApplicationShareType
	(TimeLimitedAccessType)(0),                        // 22: Authentication.TimeLimitedAccessType
	(BackupKeyType)(0),                                // 23: Authentication.BackupKeyType
	(*ApiRequest)(nil),                                // 24: Authentication.ApiRequest
	(*ApiRequestPayload)(nil),                         // 25: Authentication.ApiRequestPayload
	(*Transform)(nil),                                 // 26: Authentication.Transform
	(*DeviceRequest)(nil),                             // 27: Authentication.DeviceRequest
	(*AuthRequest)(nil),                               // 28: Authentication.AuthRequest
	(*NewUserMinimumParams)(nil),                      // 29: Authentication.NewUserMinimumParams
	(*PreLoginRequest)(nil),                           // 30: Authentication.PreLoginRequest
	(*LoginRequest)(nil),                              // 31: Authentication.LoginRequest
	(*DeviceResponse)(nil),                            // 32: Authentication.DeviceResponse
	(*Salt)(nil),                                      // 33: Authentication.Salt
	(*TwoFactorChannel)(nil),                          // 34: Authentication.TwoFactorChannel
	(*StartLoginRequest)(nil),                         // 35: Authentication.StartLoginRequest
	(*LoginResponse)(nil),                             // 36: Authentication.LoginResponse
	(*SsoUserInfo)(nil),                               // 37: Authentication.SsoUserInfo
	(*PreLoginResponse)(nil),                          // 38: Authentication.PreLoginResponse
	(*LoginAsUserRequest)(nil),                        // 39: Authentication.LoginAsUserRequest
	(*LoginAsUserResponse)(nil),                       // 40: Authentication.LoginAsUserResponse
	(*ValidateAuthHashRequest)(nil),                   // 41: Authentication.ValidateAuthHashRequest
	(*TwoFactorChannelInfo)(nil),                      // 42: Authentication.TwoFactorChannelInfo
	(*TwoFactorDuoStatus)(nil),                        // 43: Authentication.TwoFactorDuoStatus
	(*TwoFactorAddRequest)(nil),                       // 44: Authentication.TwoFactorAddRequest
	(*TwoFactorRenameRequest)(nil),                    // 45: Authentication.TwoFactorRenameRequest
	(*TwoFactorAddResponse)(nil),                      // 46: Authentication.TwoFactorAddResponse
	(*TwoFactorDeleteRequest)(nil),                    // 47: Authentication.TwoFactorDeleteRequest
	(*TwoFactorListResponse)(nil),                     // 48: Authentication.TwoFactorListResponse
	(*TwoFactorUpdateExpirationRequest)(nil),          // 49: Authentication.TwoFactorUpdateExpirationRequest
	(*TwoFactorValidateRequest)(nil),                  // 50: Authentication.TwoFactorValidateRequest
	(*TwoFactorValidateResponse)(nil),                 // 51: Authentication.TwoFactorValidateResponse
	(*TwoFactorSendPushRequest)(nil),                  // 52: Authentication.TwoFactorSendPushRequest
	(*License)(nil),                                   // 53: Authentication.License
	(*OwnerlessRecord)(nil),                           // 54: Authentication.OwnerlessRecord
	(*OwnerlessRecords)(nil),                          // 55: Authentication.OwnerlessRecords
	(*UserAuthRequest)(nil),                           // 56: Authentication.UserAuthRequest
	(*UidRequest)(nil),                                // 57: Authentication.UidRequest
	(*DeviceUpdateRequest)(nil),                       // 58: Authentication.DeviceUpdateRequest
	(*RegisterDeviceInRegionRequest)(nil),             // 59: Authentication.RegisterDeviceInRegionRequest
	(*RegistrationRequest)(nil),                       // 60: Authentication.RegistrationRequest
	(*ConvertUserToV3Request)(nil),                    // 61: Authentication.ConvertUserToV3Request
	(*RevisionResponse)(nil),                          // 62: Authentication.RevisionResponse
	(*ChangeEmailRequest)(nil),                        // 63: Authentication.ChangeEmailRequest
	(*ChangeEmailResponse)(nil),                       // 64: Authentication.ChangeEmailResponse
	(*EmailVerificationLinkResponse)(nil),             // 65: Authentication.EmailVerificationLinkResponse
	(*SecurityData)(nil),                              // 66: Authentication.SecurityData
	(*SecurityDataRequest)(nil),                       // 67: Authentication.SecurityDataRequest
	(*SecurityReportIncrementalData)(nil),             // 68: Authentication.SecurityReportIncrementalData
	(*SecurityReport)(nil),                            // 69: Authentication.SecurityReport
	(*SecurityReportSaveRequest)(nil),                 // 70: Authentication.SecurityReportSaveRequest
	(*SecurityReportRequest)(nil),                     // 71: Authentication.SecurityReportRequest
	(*SecurityReportResponse)(nil),                    // 72: Authentication.SecurityReportResponse
	(*ReusedPasswordsRequest)(nil),                    // 73: Authentication.ReusedPasswordsRequest
	(*SummaryConsoleReport)(nil),                      // 74: Authentication.SummaryConsoleReport
	(*ChangeToKeyTypeOne)(nil),                        // 75: Authentication.ChangeToKeyTypeOne
	(*ChangeToKeyTypeOneRequest)(nil),                 // 76: Authentication.ChangeToKeyTypeOneRequest
	(*ChangeToKeyTypeOneStatus)(nil),                  // 77: Authentication.ChangeToKeyTypeOneStatus
	(*ChangeToKeyTypeOneResponse)(nil),                // 78: Authentication.ChangeToKeyTypeOneResponse
	(*SetKey)(nil),                                    // 79: Authentication.SetKey
	(*SetKeyRequest)(nil),                             // 80: Authentication.SetKeyRequest
	(*CreateUserRequest)(nil),                         // 81: Authentication.CreateUserRequest
	(*NodeEnforcementAddOrUpdateRequest)(nil),         // 82: Authentication.NodeEnforcementAddOrUpdateRequest
	(*NodeEnforcementRemoveRequest)(nil),              // 83: Authentication.NodeEnforcementRemoveRequest
	(*ApiRequestByKey)(nil),                           // 84: Authentication.ApiRequestByKey
	(*ApiRequestByKAtoKAKey)(nil),                     // 85: Authentication.ApiRequestByKAtoKAKey
	(*MemcacheRequest)(nil),                           // 86: Authentication.MemcacheRequest
	(*MemcacheResponse)(nil),                          // 87: Authentication.MemcacheResponse
	(*MasterPasswordReentryRequest)(nil),              // 88: Authentication.MasterPasswordReentryRequest
	(*DeviceRegistrationRequest)(nil),                 // 89: Authentication.DeviceRegistrationRequest
	(*DeviceVerificationRequest)(nil),                 // 90: Authentication.DeviceVerificationRequest
	(*DeviceVerificationResponse)(nil),                // 91: Authentication.DeviceVerificationResponse
	(*DeviceApprovalRequest)(nil),                     // 92: Authentication.DeviceApprovalRequest
	(*DeviceApprovalResponse)(nil),                    // 93: Authentication.DeviceApprovalResponse
	(*ApproveDeviceRequest)(nil),                      // 94: Authentication.ApproveDeviceRequest
	(*EnterpriseUserAliasRequest)(nil),                // 95: Authentication.EnterpriseUserAliasRequest
	(*EnterpriseUserAddAliasRequest)(nil),             // 96: Authentication.EnterpriseUserAddAliasRequest
	(*Device)(nil),                                    // 97: Authentication.Device
	(*RegisterDeviceDataKeyRequest)(nil),              // 98: Authentication.RegisterDeviceDataKeyRequest
	(*ValidateCreateUserVerificationCodeRequest)(nil), // 99: Authentication.ValidateCreateUserVerificationCodeRequest
	(*ValidateDeviceVerificationCodeRequest)(nil),     // 100: Authentication.ValidateDeviceVerificationCodeRequest
	(*SendSessionMessageRequest)(nil),                 // 101: Authentication.SendSessionMessageRequest
	(*GlobalUserAccount)(nil),                         // 102: Authentication.GlobalUserAccount
	(*AccountUsername)(nil),                           // 103: Authentication.AccountUsername
	(*SsoServiceProviderRequest)(nil),                 // 104: Authentication.SsoServiceProviderRequest
	(*SsoServiceProviderResponse)(nil),                // 105: Authentication.SsoServiceProviderResponse
	(*UserSettingRequest)(nil),                        // 106: Authentication.UserSettingRequest
	(*ThrottleState)(nil),                             // 107: Authentication.ThrottleState
	(*ThrottleState2)(nil),                            // 108: Authentication.ThrottleState2
	(*DeviceInformation)(nil),                         // 109: Authentication.DeviceInformation
	(*UserSetting)(nil),                               // 110: Authentication.UserSetting
	(*UserDataKeyRequest)(nil),                        // 111: Authentication.UserDataKeyRequest
	(*EnterpriseUserIdDataKeyPair)(nil),               // 112: Authentication.EnterpriseUserIdDataKeyPair
	(*UserDataKey)(nil),                               // 113: Authentication.UserDataKey
	(*UserDataKeyResponse)(nil),                       // 114: Authentication.UserDataKeyResponse
	(*MasterPasswordRecoveryVerificationRequest)(nil), // 115: Authentication.MasterPasswordRecoveryVerificationRequest
	(*GetSecurityQuestionV3Request)(nil),              // 116: Authentication.GetSecurityQuestionV3Request
	(*GetSecurityQuestionV3Response)(nil),             // 117: Authentication.GetSecurityQuestionV3Response
	(*GetDataKeyBackupV3Request)(nil),                 // 118: Authentication.GetDataKeyBackupV3Request
	(*PasswordRules)(nil),                             // 119: Authentication.PasswordRules
	(*GetDataKeyBackupV3Response)(nil),                // 120: Authentication.GetDataKeyBackupV3Response
	(*GetPublicKeysRequest)(nil),                      // 121: Authentication.GetPublicKeysRequest
	(*PublicKeyResponse)(nil),                         // 122: Authentication.PublicKeyResponse
	(*GetPublicKeysResponse)(nil),                     // 123: Authentication.GetPublicKeysResponse
	(*SetEccKeyPairRequest)(nil),                      // 124: Authentication.SetEccKeyPairRequest
	(*AddAppSharesRequest)(nil),                       // 125: Authentication.AddAppSharesRequest
	(*RemoveAppSharesRequest)(nil),                    // 126: Authentication.RemoveAppSharesRequest
	(*AppShareAdd)(nil),                               // 127: Authentication.AppShareAdd
	(*AppShare)(nil),                                  // 128: Authentication.AppShare
	(*AddAppClientRequest)(nil),                       // 129: Authentication.AddAppClientRequest
	(*RemoveAppClientsRequest)(nil),                   // 130: Authentication.RemoveAppClientsRequest
	(*AddExternalShareRequest)(nil),                   // 131: Authentication.AddExternalShareRequest
	(*AppClient)(nil),                                 // 132: Authentication.AppClient
	(*GetAppInfoRequest)(nil),                         // 133: Authentication.GetAppInfoRequest
	(*AppInfo)(nil),                                   // 134: Authentication.AppInfo
	(*GetAppInfoResponse)(nil),                        // 135: Authentication.GetAppInfoResponse
	(*ApplicationSummary)(nil),                        // 136: Authentication.ApplicationSummary
	(*GetApplicationsSummaryResponse)(nil),            // 137: Authentication.GetApplicationsSummaryResponse
	(*GetVerificationTokenRequest)(nil),               // 138: Authentication.GetVerificationTokenRequest
	(*GetVerificationTokenResponse)(nil),              // 139: Authentication.GetVerificationTokenResponse
	(*SendShareInviteRequest)(nil),                    // 140: Authentication.SendShareInviteRequest
	(*TimeLimitedAccessRequest)(nil),                  // 141: Authentication.TimeLimitedAccessRequest
	(*TimeLimitedAccessStatus)(nil),                   // 142: Authentication.TimeLimitedAccessStatus
	(*TimeLimitedAccessResponse)(nil),                 // 143: Authentication.TimeLimitedAccessResponse
	(*RequestDownloadRequest)(nil),                    // 144: Authentication.RequestDownloadRequest
	(*RequestDownloadResponse)(nil),                   // 145: Authentication.RequestDownloadResponse
	(*Download)(nil),                                  // 146: Authentication.Download
	(*DeleteUserRequest)(nil),                         // 147: Authentication.DeleteUserRequest
	(*ChangeMasterPasswordRequest)(nil),               // 148: Authentication.ChangeMasterPasswordRequest
	(*ChangeMasterPasswordResponse)(nil),              // 149: Authentication.ChangeMasterPasswordResponse
	(*AccountRecoverySetupRequest)(nil),               // 150: Authentication.AccountRecoverySetupRequest
	(*AccountRecoveryVerifyCodeResponse)(nil),         // 151: Authentication.AccountRecoveryVerifyCodeResponse
	(*proto_enterprise.EnterpriseRegistration)(nil),   // 152: Enterprise.EnterpriseRegistration
	(proto_enterprise.AppClientType)(0),               // 153: Enterprise.AppClientType
}
var file_APIRequest_proto_depIdxs = []int32{
	28,  // 0: Authentication.PreLoginRequest.authRequest:type_name -> Authentication.AuthRequest
	1,   // 1: Authentication.PreLoginRequest.loginType:type_name -> Authentication.LoginType
	28,  // 2: Authentication.LoginRequest.authRequest:type_name -> Authentication.AuthRequest
	...
	42,  // 10: Authentication.LoginResponse.channels:type_name -> Authentication.TwoFactorChannelInfo
	33,  // 11: Authentication.LoginResponse.salt:type_name -> Authentication.Salt
	2,   // 12: Authentication.PreLoginResponse.deviceStatus:type_name -> Authentication.DeviceStatus
	33,  // 13: Authentication.PreLoginResponse.salt:type_name -> Authentication.Salt
	34,  // 14: Authentication.PreLoginResponse.OBSOLETE_FIELD:type_name -> Authentication.TwoFactorChannel
	37,  // 15: Authentication.PreLoginResponse.ssoUserInfo:type_name -> Authentication.SsoUserInfo
	...
	14,  // 19: Authentication.TwoFactorAddRequest.channelType:type_name -> Authentication.TwoFactorChannelType
	12,  // 20: Authentication.TwoFactorAddRequest.duoPushType:type_name -> Authentication.TwoFactorPushType
	42,  // 21: Authentication.TwoFactorListResponse.channels:type_name -> Authentication.TwoFactorChannelInfo
	15,  // 22: Authentication.TwoFactorUpdateExpirationRequest.expireIn:type_name -> Authentication.TwoFactorExpiration
	13,  // 23: Authentication.TwoFactorValidateRequest.valueType:type_name -> Authentication.TwoFactorValueType
	15,  // 24: Authentication.TwoFactorValidateRequest.expireIn:type_name -> Authentication.TwoFactorExpiration
	12,  // 25: Authentication.TwoFactorSendPushRequest.pushType:type_name -> Authentication.TwoFactorPushType
	15,  // 26: Authentication.TwoFactorSendPushRequest.expireIn:type_name -> Authentication.TwoFactorExpiration
	3,   // 27: Authentication.License.licenseStatus:type_name -> Authentication.LicenseStatus
	54,  // 28: Authentication.OwnerlessRecords.ownerlessRecord:type_name -> Authentication.OwnerlessRecord
	1,   // 29: Authentication.UserAuthRequest.loginType:type_name -> Authentication.LoginType
	2,   // 30: Authentication.DeviceUpdateRequest.deviceStatus:type_name -> Authentication.DeviceStatus
	28,  // 31: Authentication.RegistrationRequest.authRequest:type_name -> Authentication.AuthRequest
	56,  // 32: Authentication.RegistrationRequest.userAuthRequest:type_name -> Authentication.UserAuthRequest
	28,  // 33: Authentication.ConvertUserToV3Request.authRequest:type_name -> Authentication.AuthRequest
	56,  // 34: Authentication.ConvertUserToV3Request.userAuthRequest:type_name -> Authentication.UserAuthRequest
	66,  // 35: Authentication.SecurityDataRequest.recordSecurityData:type_name -> Authentication.SecurityData
	66,  // 36: Authentication.SecurityDataRequest.masterPasswordSecurityData:type_name -> Authentication.SecurityData
	68,  // 37: Authentication.SecurityReport.securityReportIncrementalData:type_name -> Authentication.SecurityReportIncrementalData
	69,  // 38: Authentication.SecurityReportSaveRequest.securityReport:type_name -> Authentication.SecurityReport
	69,  // 39: Authentication.SecurityReportResponse.securityReport:type_name -> Authentication.SecurityReport
	17,  // 40: Authentication.ChangeToKeyTypeOne.objectType:type_name -> Authentication.ObjectTypes
	75,  // 41: Authentication.ChangeToKeyTypeOneRequest.changeToKeyTypeOne:type_name -> Authentication.ChangeToKeyTypeOne
	77,  // 42: Authentication.ChangeToKeyTypeOneResponse.changeToKeyTypeOneStatus:type_name -> Authentication.ChangeToKeyTypeOneStatus
	79,  // 43: Authentication.SetKeyRequest.keys:type_name -> Authentication.SetKey
	152, // 44: Authentication.CreateUserRequest.enterpriseRegistration:type_name -> Enterprise.EnterpriseRegistration
	0,   // 45: Authentication.ApiRequestByKey.supportedLanguage:type_name -> Authentication.SupportedLanguage
	20,  // 46: Authentication.ApiRequestByKAtoKAKey.sourceRegion:type_name -> Authentication.Region
	0,   // 47: Authentication.ApiRequestByKAtoKAKey.supportedLanguage:type_name -> Authentication.SupportedLanguage
	20,  // 48: Authentication.ApiRequestByKAtoKAKey.destinationRegion:type_name -> Authentication.Region
	7,   // 49: Authentication.MasterPasswordReentryRequest.action:type_name -> Authentication.MasterPasswordReentryActionType
	2,   // 50: Authentication.DeviceVerificationResponse.deviceStatus:type_name -> Authentication.DeviceStatus
	19,  // 51: Authentication.ThrottleState.type:type_name -> Authentication.ThrottleType
	2,   // 52: Authentication.DeviceInformation.deviceStatus:type_name -> Authentication.DeviceStatus
	112, // 53: Authentication.UserDataKey.enterpriseUserIdDataKeyPairs:type_name -> Authentication.EnterpriseUserIdDataKeyPair
	113, // 54: Authentication.UserDataKeyResponse.userDataKeys:type_name -> Authentication.UserDataKey
	119, // 55: Authentication.GetDataKeyBackupV3Response.passwordRules:type_name -> Authentication.PasswordRules
	122, // 56: Authentication.GetPublicKeysResponse.keyResponses:type_name -> Authentication.PublicKeyResponse
	127, // 57: Authentication.AddAppSharesRequest.shares:type_name -> Authentication.AppShareAdd
	21,  // 58: Authentication.AppShareAdd.shareType:type_name -> Authentication.ApplicationShareType
	21,  // 59: Authentication.AppShare.shareType:type_name -> Authentication.ApplicationShareType
	153, // 60: Authentication.AddAppClientRequest.appClientType:type_name -> Enterprise.AppClientType
	153, // 61: Authentication.AppClient.appClientType:type_name -> Enterprise.AppClientType
	128, // 62: Authentication.AppInfo.shares:type_name -> Authentication.AppShare
	132, // 63: Authentication.AppInfo.clients:type_name -> Authentication.AppClient
	134, // 64: Authentication.GetAppInfoResponse.appInfo:type_name -> Authentication.AppInfo
	136, // 65: Authentication.GetApplicationsSummaryResponse.applicationSummary:type_name -> Authentication.ApplicationSummary
	22,  // 66: Authentication.TimeLimitedAccessRequest.timeLimitedAccessType:type_name -> Authentication.TimeLimitedAccessType
	142, // 67: Authentication.TimeLimitedAccessResponse.userAccessStatus:type_name -> Authentication.TimeLimitedAccessStatus
	142, // 68: Authentication.TimeLimitedAccessResponse.teamAccessStatus:type_name -> Authentication.TimeLimitedAccessStatus
	142, // 69: Authentication.TimeLimitedAccessResponse.recordAccessStatus:type_name -> Authentication.TimeLimitedAccessStatus
	146, // 70: Authentication.RequestDownloadResponse.downloads:type_name -> Authentication.Download
	23,  // 71: Authentication.AccountRecoveryVerifyCodeResponse.backupKeyType:type_name -> Authentication.BackupKeyType
...
func file_APIRequest_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_APIRequest_proto_msgTypes[117].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TimeLimitedAccessRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_APIRequest_proto_msgTypes[118].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TimeLimitedAccessStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_APIRequest_proto_msgTypes[119].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TimeLimitedAccessResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache

...
func (rk *recordKeyStorage) Initialize(recordKey sdk.IStorageRecordKey) {
...
func (rk *recordKeyStorage) Init(source interface{}) (err error) {
	if recordKey, ok := source.(sdk.IStorageRecordKey); ok {
...
func (sfk *sharedFolderKeyStorage) Initialize(recordKey sdk.IStorageSharedFolderKey) {
...
func (sfk *sharedFolderKeyStorage) Init(source interface{}) (err error) {
	if sharedFolderKey, ok := source.(sdk.IStorageSharedFolderKey); ok {
...
func (sfp *sharedFolderPermissionStorage) Initialize(permission sdk.IStorageSharedFolderPermission) {
...
func (sfp *sharedFolderPermissionStorage) Init(source interface{}) (err error) {
	if permission, ok := source.(sdk.IStorageSharedFolderPermission); ok {
...
func (tk *teamKeyStorage) Initialize(teamKey sdk.IStorageTeamKey) {
...
func (tk *teamKeyStorage) Init(source interface{}) (err error) {
	if teamKey, ok := source.(sdk.IStorageTeamKey); ok {
...
func (fr *folderRecordStorage) Initialize(folderRecord sdk.IStorageFolderRecord) {
...
func (fr *folderRecordStorage) Init(source interface{}) (err error) {
	if folderRecord, ok := source.(sdk.IStorageFolderRecord); ok {

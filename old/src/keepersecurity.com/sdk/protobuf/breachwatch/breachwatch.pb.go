...
type BreachWatchRecordRequest struct {
	...
	RecordUid            []byte              `protobuf:"bytes,1,opt,name=recordUid,proto3" json:"recordUid"`
	EncryptedData        []byte              `protobuf:"bytes,2,opt,name=encryptedData,proto3" json:"encryptedData"`
	BreachWatchInfoType  BreachWatchInfoType `protobuf:"varint,3,opt,name=breachWatchInfoType,proto3,enum=BreachWatch.BreachWatchInfoType" json:"breachWatchInfoType"`
	UpdateUserWhoScanned bool                `protobuf:"varint,4,opt,name=updateUserWhoScanned,proto3" json:"updateUserWhoScanned"`
}
...
type BreachWatchUpdateRequest struct {
	...
	BreachWatchRecordRequest []*BreachWatchRecordRequest `protobuf:"bytes,1,rep,name=breachWatchRecordRequest,proto3" json:"breachWatchRecordRequest"`
	EncryptedData            []byte                      `protobuf:"bytes,2,opt,name=encryptedData,proto3" json:"encryptedData"`
}
...
type BreachWatchUpdateResponse struct {
	...
	BreachWatchRecordStatus []*BreachWatchRecordStatus `protobuf:"bytes,1,rep,name=breachWatchRecordStatus,proto3" json:"breachWatchRecordStatus"`
}
...
type BreachWatchTokenRequest struct {
	...
	BreachWatchToken []byte `protobuf:"bytes,1,opt,name=breachWatchToken,proto3" json:"breachWatchToken"`
}
...
type BreachWatchTokenResponse struct {
	...
	BreachWatchToken []byte `protobuf:"bytes,1,opt,name=breachWatchToken,proto3" json:"breachWatchToken"`
	ClientEncrypted  bool   `protobuf:"varint,2,opt,name=clientEncrypted,proto3" json:"clientEncrypted"`
}
...
type AnonymizedTokenResponse struct {
	...
	DomainToken   []byte `protobuf:"bytes,1,opt,name=domainToken,proto3" json:"domainToken"`
	EmailToken    []byte `protobuf:"bytes,2,opt,name=emailToken,proto3" json:"emailToken"`
	PasswordToken []byte `protobuf:"bytes,3,opt,name=passwordToken,proto3" json:"passwordToken"`
}
...
type HashCheck struct {
	...
	Hash1 []byte `protobuf:"bytes,1,opt,name=hash1,proto3" json:"hash1"` // if supplied, check this hash
	Euid  []byte `protobuf:"bytes,2,opt,name=euid,proto3" json:"euid"`   // if supplied, check this euid - if hash is also supplied, update the hash for this euid
}
...
type BreachWatchStatusRequest struct {
	...
	AnonymizedToken []byte       `protobuf:"bytes,1,opt,name=anonymizedToken,proto3" json:"anonymizedToken"`
	HashCheck       []*HashCheck `protobuf:"bytes,2,rep,name=hashCheck,proto3" json:"hashCheck"`
	RemovedEuid     [][]byte     `protobuf:"bytes,3,rep,name=removedEuid,proto3" json:"removedEuid"`
}
...
type HashStatus struct {
	...
	Hash1          []byte `protobuf:"bytes,1,opt,name=hash1,proto3" json:"hash1"` // if supplied a uid is supplied for this hash
	Euid           []byte `protobuf:"bytes,2,opt,name=euid,proto3" json:"euid"`   // if not supplied, this hash is not being tracked
	BreachDetected bool   `protobuf:"varint,3,opt,name=breachDetected,proto3" json:"breachDetected"`
}
...
type BreachWatchStatusResponse struct {
	...
	HashStatus []*HashStatus `protobuf:"bytes,2,rep,name=hashStatus,proto3" json:"hashStatus"`
}
...
type EnterprisePublicKeyResponse struct {
	...
	EnterpriseECCPublicKey []byte `protobuf:"bytes,2,opt,name=enterpriseECCPublicKey,proto3" json:"enterpriseECCPublicKey"`
}
...
type FreeScanRequest struct {
	...
	HashedEmail []byte `protobuf:"bytes,1,opt,name=hashedEmail,proto3" json:"hashedEmail"`
}
...
type FreeScanResponse struct {
	...
	EmailBreaches    int32 `protobuf:"varint,1,opt,name=emailBreaches,proto3" json:"emailBreaches"`
	PasswordBreaches int32 `protobuf:"varint,2,opt,name=passwordBreaches,proto3" json:"passwordBreaches"`
}
...
type PaidUserResponse struct {
	...
	PaidUser bool `protobuf:"varint,1,opt,name=paidUser,proto3" json:"paidUser"`
}
...
type BreachEvent struct {
	...
	PasswordInBreach bool   `protobuf:"varint,3,opt,name=passwordInBreach,proto3" json:"passwordInBreach"`
...
type UseOneTimeTokenResponse struct {
	...
	EmailBreaches    int32          `protobuf:"varint,1,opt,name=emailBreaches,proto3" json:"emailBreaches"`
	PasswordBreaches int32          `protobuf:"varint,2,opt,name=passwordBreaches,proto3" json:"passwordBreaches"`
	BreachEvents     []*BreachEvent `protobuf:"bytes,3,rep,name=breachEvents,proto3" json:"breachEvents"`
...
type OneTimeUseToken struct {
	...
	Email string `protobuf:"bytes,1,opt,name=email,proto3" json:"email"`
	Pad   string `protobuf:"bytes,2,opt,name=pad,proto3" json:"pad"`
}
...
type FreePasswordScanRequest struct {
	...
	HashedPassword []byte `protobuf:"bytes,1,opt,name=hashedPassword,proto3" json:"hashedPassword"`
}
...
type FreePasswordScanResponse struct {
	...
	PasswordBreaches int64 `protobuf:"varint,1,opt,name=passwordBreaches,proto3" json:"passwordBreaches"`
}
...
var file_breachwatch_proto_rawDesc = []byte{
	...
	0x53, 0x53, 0x57, 0x4f, 0x52, 0x44, 0x10, 0x01, 0x42, 0x50, 0x0a, 0x18, 0x63, 0x6f, 0x6d, 0x2e,
	...
	0x68, 0x5a, 0x27, 0x6b, 0x65, 0x65, 0x70, 0x65, 0x72, 0x73, 0x65, 0x63, 0x75, 0x72, 0x69, 0x74,
	0x79, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x62,
	0x72, 0x65, 0x61, 0x63, 0x68, 0x77, 0x61, 0x74, 0x63, 0x68, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
